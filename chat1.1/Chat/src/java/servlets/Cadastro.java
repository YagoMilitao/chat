...
public class Cadastro extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        boolean emailvazio = false, uservazio = false, senhavazia = false, senhasdiferentes = false, errocadastro = false;
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("				\n"
                    ...
                    + "					<div class=\"input-group\">\n"
                    + "						\n"
                    + "						<input type=\"text\" id=\"user\" name = \"user\" class=\"form-control mb-4\" placeholder=\"Username\" maxlength = \"20\">\n"
                    + "						\n"
                    + "					</div>\n"
            );
            ...
            out.println("				\n"
                    ...
                    + "					<div class=\"input-group\">\n"
                    + "						\n"
                    + "						<input type=\"password\" id=\"senha_conf\" name = \"senha_conf\" class=\"form-control mb-4\" placeholder=\"Confirm Password\">\n"
                    + "						\n"
                    + "					</div>\n"
            );
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (!senha.equals(senha_conf) && (senha.equals("")) || senha_conf.equals("")) {
