...
public class ChatPrincipal extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Chat - "+sessao.getAttribute("user")+"</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Olá " + sessao.getAttribute("user") + "!</h1>");
            out.println("<a href = \"Logout\" class = \"btn btn-primary\">Sair</a>");
            out.println("</form>");
            out.println("</body>");
            out.println("</html>");
        }
